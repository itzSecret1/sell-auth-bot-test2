...
// Iniciar auto-push a GitHub cuando hay cambios
import { startGitAutoPush } from './utils/gitAutoPush.js';
startGitAutoPush().catch(err => {
  console.error('[INDEX] Error iniciando auto-push:', err);
});
